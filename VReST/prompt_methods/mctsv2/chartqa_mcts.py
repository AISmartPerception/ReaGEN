...
class ReasoningMCTSNode(MCTSNode):
    ...
    def __init__(self, question, sub_questions, sub_answers, depth, parent: 'ReasoningMCTSNode' = None, r0=0.0, r1=0.0,
                 cfg=None, model=None, image_url=None):
        self._conf = None
        self.children = []
        self.depth = depth
        self._r0 = r0
    ...
    @property
    def reward(self):
        self._r0 = self._r0 - 0.5 # [-0.5, 0.5]
        self._r1 = self._r1 - 0.5 # [-0.5, 0.5]
        return self._r0 + self._r1 # [-1, 1]
...
def mcts_forward_v2(query, img_path, model, cfg):
    with open(img_path, "rb") as image_file:
        image_data = image_file.read()
    image_base64 = base64.b64encode(image_data).decode('utf-8')
    image_url = f"data:image/jpeg;base64,{image_base64}"
    
    mcts = MCTS(w_exp=1, prior=True, aggr_reward='mean', aggr_child='mean')
    ...
    memory = {}
    memory["sub_questions"] = max_n.sub_questions
    memory["sub_answers"] = max_n.sub_answers
